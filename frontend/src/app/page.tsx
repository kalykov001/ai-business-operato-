          ...
          <div className="mx-auto max-w-7xl space-y-8">
            ...
            <section>
              ...
              <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                ...
                <div className="rounded-xl border bg-card p-5 shadow-sm">
                  ...
                  <p className="mt-4 text-sm text-muted-foreground">Emails</p>
                ...
                <div className="rounded-xl border bg-card p-5 shadow-sm">
                  ...
                  <p className="mt-4 text-sm text-muted-foreground">Meetings</p>
                ...
                <div className="rounded-xl border bg-card p-5 shadow-sm">
                  ...
                  <p className="mt-4 text-sm text-muted-foreground">Contacts</p>
                ...
                <div className="rounded-xl border bg-card p-5 shadow-sm">
                  ...
                  <p className="mt-4 text-sm text-muted-foreground">Tasks</p>
            ...
            <section className="grid gap-6 lg:grid-cols-2">
              ...
              <div className="rounded-xl border bg-card shadow-sm">
                ...
                <div className="border-t p-4">
                  <button onClick={() => push("/calendar")} className="flex w-full items-center justify-center gap-2 text-sm font-medium hover:underline">
                    Open Calendar
                    <ArrowRight size={14} />
                  </button>
                </div>
            ...
            <section className="grid gap-6 lg:grid-cols-2">
              ...
              <div className="rounded-xl border bg-card shadow-sm">
                <div className="flex items-center justify-between border-b p-5">
                  <div>
                    <h2 className="font-semibold">Important emails</h2>
                ...
                <div className="border-t p-4">
                  <button onClick={() => push("/gmail")} className="flex w-full items-center justify-center gap-2 text-sm font-medium hover:underline">
                    Open Gmail
                    <ArrowRight size={14} />
                  </button>
                </div>
              ...
              <div className="rounded-xl border bg-card shadow-sm">
                <div className="flex items-center justify-between border-b p-5">
                  ...
                  <HardDrive size={19} className="text-muted-foreground" />
                </div>
                ...
                <div className="border-t p-4">
                  <button onClick={() => push("/drive")} className="flex w-full items-center justify-center gap-2 text-sm font-medium hover:underline">
                    Open Drive
                    <ArrowRight size={14} />
                  </button>
                </div>
            ...
            <div className="flex items-center justify-center pb-4 text-xs text-muted-foreground">
              Operator AI will analyze your connected business data.
            </div>
          </div>
        </main>
      </SidebarInset>
