...

{
  ...
  function: {
    name: "get_contacts",
    description:
      "Get all CRM contacts belonging to the current user.",
    parameters: {
      type: "object",
      properties: {},
      required: [],
...

{
  ...
  function: {
    name: "create_contact",
    description:
      "Create a new CRM contact for the current user.",
    parameters: {
      type: "object",
      properties: {
        first_name: {
...

{
...

  {
    ...
    function: {
      ...
      description:
        "Get the current user's Google Calendar events.",
      parameters: {
        type: "object",
        properties: {},
        required: [],
  ...
  if (!args.contact_id) {
    ...
    result = JSON.stringify({
      ...
      // =====================================
        ...
        functionName === "get_gmail_messages"
      ) {
        if (!googleToken) {
          result = JSON.stringify({
            success: false,
